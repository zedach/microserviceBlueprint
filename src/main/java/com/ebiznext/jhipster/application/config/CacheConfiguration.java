package com.ebiznext.jhipster.application.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("microserviceBlueprint");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("microserviceBlueprint");
        ...
        config.getMapConfigs().put("com.ebiznext.jhipster.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
